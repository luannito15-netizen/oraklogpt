    ...
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 lg:px-8">
        ...
        <div className="mt-12 space-y-10 text-sm leading-7 text-[var(--text-secondary)]">
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">1. Aceitação dos termos</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">2. O que é o ORAKLO</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">3. Elegibilidade</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">4. Taxas da plataforma</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">5. Resolução de eventos</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">6. Uso aceitável</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-[family-name:var(--font-anton)] text-xl text-[var(--text)]">7. Contato</h2>
            <p>
